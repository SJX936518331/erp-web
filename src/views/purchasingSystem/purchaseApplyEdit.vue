    ...
    <div class="container">
        <Card class="admin-card" v-if="curObject">
            <Form class="admin-form" ref="form" :model="curObject" :label-width="100" label-position="right" :rules="validate">
                ...
                <FormItem label="中止" prop="note">
                    <Checkbox v-model="curObject.is_cancel">Checkbox</Checkbox>
                </FormItem>
...
//                }
            ...
            onProductSelect(obj) {
                ...
                this.$http.post(`/sale_order_item/add`, {
                    sale_order_id: this.curObjectId,
                    sku_id: obj.sku.id,
                    number: 1,
                    note: '',
