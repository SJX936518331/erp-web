    ...
    <div class="container">
        <Card class="admin-card">
            <Form class="admin-form" ref="form" :model="curObject" :label-width="100" label-position="right" :rules="validate">
                <FormItem label="付款账户" prop="out_bank_id">
                    <div class="form-selector">
                        <div class="value">{{ curObject.out_bank_name }}</div>
                        <div class="selector">
                            <my-bank-selector @select="onOutBankSelect" />
                        </div>
                    </div>
                </FormItem>
                <FormItem label="收款账户" prop="in_bank_id">
                    <div class="form-selector">
                        <div class="value">{{ curObject.in_bank_name }}</div>
                        <div class="selector">
                            <my-bank-selector @select="onInBankSelect" />
                        </div>
                    </div>
                </FormItem>
                <FormItem label="金额" prop="money">
                    <Input v-model="curObject.money" placeholder=""></Input>
                </FormItem>
        ...
        methods: {
            ...
            save() {
                this.$refs['form'].validate(valid => {
                    ...
                    if (this.curObject.out_bank_id === this.curObject.in_bank_id) {
                        this.$Message.error('付款账户和收款账户不能相同')
                        return
                    }
