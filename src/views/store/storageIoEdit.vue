    ...
    <div>
        <Card class="admin-card" v-if="curObject">
            <Form class="admin-form" ref="form" :model="curObject" :label-width="100" label-position="right" :rules="validate">
                <FormItem label="单据类型" prop="type">
                    <Select class="form-common-width" v-model="curObject.type" placeholder="" :disabled="!formEditable">
                        <Option value="1">入库</Option>
                        <Option value="2">出库</Option>
                    </Select>
                </FormItem>
                <FormItem label="出入库类型" prop="storage_io_type_id ">
                    <Select class="form-common-width" v-model="curObject.storage_io_type_id" placeholder="" :disabled="!formEditable">
                ...
                <FormItem label="备注" prop="note">
                    <Input class="form-common-width" v-model="curObject.note"
                           type="textarea" placeholder="" :disabled="!formEditable"></Input>
                </FormItem>
                <Row>
                    <Col span="6">
        ...
        <Card class="admin-card">
            ...
            <div class="admin-tool-bar">
                ...
                <div class="tool-right" v-if="curObject.check_state !== '1'">
                    ...
                    <my-sku-selector @select="onSkuSelect" :storeId="curObject.type === '2' ? curObject.store_id : ''" :before="checkStore"/>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods: {
            checkStore() {
                if (this.curObject.type === '2' && !this.curObject.store_id) {
