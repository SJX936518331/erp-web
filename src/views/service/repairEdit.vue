<template>
    <div class="container">
        ...
        <Card class="admin-card">
            ...
            <my-table v-model="users" :columns-list="columns" :editIncell="curObject.check_state === '0'" ref="table"></my-table>
        </Card>
    </div>
                            ...
                            return h("div", [
                                h(
                                    "Button",
                                    {
                                        ...
                                        on: {
                                            click: () => {
                                                this.removeItem(this.users[params.index], params.index)
                                            }
                                        }
                                    },
                                    "删除"
        ...
        methods: {
            getData() {
                ...
                this.$http.get(`/${this.modelName}/detail?id=` + this.curObjectId).then(
                    response => {
                        ...
                        this.users = this.curObject.users
            ...
            save() {
                this.$refs['form'].validate(valid => {
                    ...
                    this.curObject.users = this.users
